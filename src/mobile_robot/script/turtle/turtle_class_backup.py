...
class Turtlebot1(object):
    def __init__(self):
        ...
        self.sub_globPos = rospy.Subscriber('/vrpn_client_node/turtle1/pose', PoseStamped, self.globPos_callback)
        # publish topics
...
class Turtlebot2(object):
    ...
    def __init__(self):
        ...
        self.sub_globPos = rospy.Subscriber('/vrpn_client_node/turtle2/pose', PoseStamped, self.globPos_callback)
...
class Turtlebot3(object):
    ...
    def __init__(self):
        ...
        self.sub_globPos = rospy.Subscriber('/vrpn_client_node/turtle3/pose', PoseStamped, self.globPos_callback)
