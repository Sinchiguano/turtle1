...
if("TRUE" STREQUAL "TRUE")
  set(multimaster_msgs_fkie_SOURCE_PREFIX /home/turtlebot/catkin_ws/src/multimaster_fkie/multimaster_msgs_fkie)
  set(multimaster_msgs_fkie_DEVEL_PREFIX /home/turtlebot/catkin_ws/devel)
  ...
  set(multimaster_msgs_fkie_INSTALL_PREFIX /home/turtlebot/catkin_ws/install)
...
if(NOT "/home/turtlebot/catkin_ws/devel/include " STREQUAL " ")
  set(multimaster_msgs_fkie_INCLUDE_DIRS "")
  set(_include_dirs "/home/turtlebot/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multimaster_msgs_fkie' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/catkin_ws/src/multimaster_fkie/multimaster_msgs_fkie/${idir}'.  ${_report}")
    endif()
